...
class menu(pygame.sprite.Sprite):
        def __init__(self, screen, name, text):
            super().__init__()
            self.rect = pygame.Rect(1075, 20, 400, 670)
        ...
        def update(self):
            ...
            self.screen.blit(font.render("Keep walking to find evidence", 1, self.textColor), pygame.Rect(self.rect.top + 360, self.rect.left + 20, self.rect.right, self.rect.bottom))
